"""Kappa-vs-expert distribution across k=3 temp=0 replicates for the pairwise Study-2 arms
...
def main():
    ...
    print(f"=== Study 2 pairwise arms vs the expert — k=3 temp=0 replicates ({M}) ===")
    ...
    res = JV / f"pairwise_reps_vs_expert_{M}.json"
