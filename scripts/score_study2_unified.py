"""Unified Study-2 comparison vs expert gold, across ALL architectures on ONE backbone
...
JV = ROOT / "results" / "study2_validation"
...
def main():
    ...
    print(f"=== Study 2 vs expert gold — unified, backbone {M}, temp=0 ===")
    ...
    out = JV / f"unified_vs_expert_{M}.json"
    out.write_text(json.dumps({"backbone": M, "temperature": 0, "rows": rows, "provenance": prov,
                               "note": "kappa = per-(proposal,call) quadratic-weighted 3-level agreement vs the expert; "
